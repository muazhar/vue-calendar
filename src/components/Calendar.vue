    ...
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat color="white">
            <v-btn class="mr-4" color="grey darken-2" @click="dialog = true" dark>
                New Event
            </v-btn>
            ...
            <v-card>
                <v-container>
                    <v-form @submit.prevent="addEvent">
                        ...
                        <v-text-field v-model="color" type="color" label="Select Color"></v-text-field>
                        <v-btn color="primary" type="submit" class="mr-4" @click.stop="dialog = false">Create Event</v-btn>
                        <v-btn color="warning" class="mr-4" @click.stop="dialog = false">Close</v-btn>
